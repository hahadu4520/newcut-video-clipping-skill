...
[![转行 AI：先找可迁移能力](examples/01-transferable-skills.jpg)](examples/01-transferable-skills.mp4)

### 比较 AI 工具：就跑同一个任务

[![比较 AI 工具：就跑同一个任务](examples/02-compare-ai-tools.jpg)](examples/02-compare-ai-tools.mp4)
